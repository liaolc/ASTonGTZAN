...
Most of my viewable work and results can be seen in the [/egs/GTZAN/](https://github.com/liaolc/ASTonGTZAN/tree/main/egs/GTZAN) folder and subfolders and google colab notebooks in [/colab/GTZANNotebooks/](https://github.com/liaolc/ASTonGTZAN/tree/main/colab/GTZANNotebooks). I have also worked heavily in modifying files in [/src/](https://github.com/liaolc/ASTonGTZAN/tree/main/src) and /src/models. 
